...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#1d0269;">
    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
     <a class="navbar-brand hed" href="#"><!-- <img src="{{asset('img/logo.png')}}" style="width:90px"> --></a>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
             <a class="btn btn-md btn-outline-white nav-link hed-r" href="{{url('/logout')}}"><i class="fa fa-sign-out"></i>&nbsp;Logout</a>
             </li>
             <li class="nav-item">

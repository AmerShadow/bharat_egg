...
<!--     <link href="{{url('css/main.css')}}" rel="stylesheet" type="text/css">
 -->    <link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.1.8/components/icon.min.css'>
    <link href="{{url('css/select.css')}}" rel="stylesheet" type="text/css">
    <link href="{{url('css/transition.css')}}" rel="stylesheet" type="text/css">
    <!-- <link href="{{url('css/dropdown.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{url('css/imageviewer.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{url('https://fonts.googleapis.com/css?family=Montserrat:400,700|Roboto:400,400italic,500,500italic,700,700italic,300italic,300')}}" rel='stylesheet' type='text/css'>
...
<nav class="navbar navbar-expand-lg navbar-dark   m-0 navbar-scrollable" style="background-color:#1d0269;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
                    ...
                    <img class="" src="{{asset('img/logo.png')}}" width="100px" height="80px">
                        <li class="nav-item ">
                            <a class="nav-link waves-effect waves-light serif" href="{{route('admin.home')}}">
...
<div class="row m-0 p-0">
    <div class="col-md-2 m-0 card pt-3 " style="border-radius: 0px;background-color:#1d0269;">
        ...
        <ul class="list-unstyled">
            <li class="nav-item " >
                            <a class="nav-link waves-effect waves-light serif white-text" style="width: 100%" href="{{route('admin.home')}}">
                                <i class="fa fa-tachometer"></i> &ensp;Dashboard
                            </a>
        </li>
        <li class="nav-item " >
                            <a class="nav-link waves-effect waves-light serif white-text" style="width: 100%" href="{{route('admin.paper')}}">
                                <i class="fa fa-file"></i> &ensp;Question Papers
                            </a>
        </li>
        <li class="nav-item " >
                            <a class="nav-link waves-effect waves-light serif white-text" style="width: 100%" href="{{route('admin.subject')}}">
    ...
    <div class="col-md-10 m-0  pl-0 pr-0 rgba-grey-light">
        <!-- <div class="col-lg-12 text-right"><a class="btn btn-md btn-outline-secondary" href="{{route('logout')}}">Logout</a></div> -->
...
<script src="{{url('js/imageviewer.min.js')}}"></script>

 -->
<script type="text/javascript" src="{{url('js/tinymce/js/tinymce/tinymce.min.js')}}"></script>
<script src="{{url('js/tinymce/js/tinymce/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image')}}" ></script>
</body>
</html>
...
return [
    ...
    */
    ...
    'logo' => '<img src="svg/logo.png" style="width:50px;height:50px"><b>Bharat Eggs</b>',
    'logo_mini' => '<img src="svg/logo.png" style="width:50px;height:50px" />',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Dashboard',
            'url'         => '/home',
            'icon'        => '<img src="svg/logo.png" style="width:50px;height:50px" />',

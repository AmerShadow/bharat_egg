...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(url('css/skins/_all-skins.min.css')); ?>">
  <!-- Morris chart -->
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="<?php echo e(url('https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic')); ?>">
</head>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('svg/user.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('svg/user3-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('svg/user4-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('svg/user.jpg')); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs">Sayed Mazhar</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
<script src="<?php echo e(url('js/pages/dashboard.js')); ?>"></script>

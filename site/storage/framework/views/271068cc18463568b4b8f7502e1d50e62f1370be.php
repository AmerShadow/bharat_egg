    	...
    	<div class="col-xs-4">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class=" text-center" style="margin:0;"><?php echo e(@App\Saller::where('id',$id)->value('name')); ?></h3>
              <h4 class=" text-center" style="margin:0;">Legder</h4>
              <h4 class=" text-center" style="margin:0;"><?php echo e(@App\Saller::where('id',$id)->value('address')); ?></h4>

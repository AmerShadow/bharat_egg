...
<h5 style="text-align: left;margin: 0px">Invoice No:<?php echo e($bill->bill_number); ?></h5>
		...
		<tr >
			  ...
			  <tr >
                ...
                <tr >
                  ...
                  <td style="border: 1px solid black">RS.<?php echo e($bill->payment_balance); ?></td>
                ...
                <tr >
                  ...
                  <td style="border: 1px solid black"><?php echo e($bill->balance_t); ?></td>

              ...
              <table class="table table-hover">
                ...
                <tr >
                 <td>Vehical Expense</td>
                  <td><?php echo e(@App\ExpVehical::sum('amount')); ?></td>
                </tr>
                <tr>
                 <td>Labour Expense</td>
                      <td><?php echo e(@App\ExpLabour::sum('amount')); ?></td>
                </tr>
                <tr>
                 <td>Other Expense</td>
                   <td><?php echo e(@App\ExpExtra::sum('amount')); ?></td>
                </tr>
                <tr  style="background-color: red;color: white">
                 <td>Total Expense</td>
                   <td><i class="fa fa-rupee"></i> <?php echo e(@App\ExpExtra::sum('amount')+@App\ExpLabour::sum('amount')+@App\ExpVehical::sum('amount')); ?></td>
                </tr>

	...
	<div class="col-sm-12 text-right " style="margin-bottom: 2rem">
      ...
      <div class="row">
      	...
      	<div class="col-md-6" style="height: 250px;overflow-y: scroll;">
           ...
           <div class="box box-info">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Stock Reciept : Recipt number<?php echo e(@App\RecNumber::first()->value('number')); ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
      	...
      	<div class="col-md-6">
      		   <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create New Saller</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo e(route('saller_add')); ?>" method="POST">
              <?php echo csrf_field(); ?>
      	...
      	<div class="col-md-6" style="height: 250px;overflow-y: scroll;">
      		<div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">All Saller</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php $__currentLoopData = @$saller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <tr>

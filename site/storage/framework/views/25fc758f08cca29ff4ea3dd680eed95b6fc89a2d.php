...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="<?php echo e(route('sale_det')); ?>" class="small-box-footer">More info <i
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                <div class="inner">
                    ...
                    <p>Balance <?php echo e(date('d')); ?> </p>
                </div>
                <div class="icon">
                    <i class="ion ion-pie-graph"></i>
                </div>
                <a href="<?php echo e(route('balance-sheet')); ?>" class="small-box-footer">More info <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
    ...
    <div class="col-sm-12 text-right " style="margin-bottom: 2rem">
        ...
        <a href="<?php echo e(route('sale_det')); ?>"><span class="label label-success"><i class="fa fa-eye"></i>&ensp;Sale
                Ledger</span></a>

        <a href="<?php echo e(route('balance-sheet')); ?>"><span class="label label-info"><i class="fa fa-eye"></i>&ensp;Balance
                Sheet</span></a>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__currentLoopData = @$cust; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><i
                                        class="fa fa-rupee"></i><?php echo e(@App\StockOut::where('cust_id', $row->id)->sum('amount') - @App\StockOut::where('cust_id', $row->id)->sum('payment')); ?>

                                </td>
                                <td><i
                                        class="fa fa-shopping-cart"></i><?php echo e(@App\StockOut::where('cust_id', $row->id)->sum('balance_t') - @App\StockOut::where('cust_id', $row->id)->sum('deposit_t')); ?>

                                </td>
                                <td> <a href="<?php echo e(route('cust_del', $row->id)); ?>"><span
                                            class="label label-danger">Delete</span></a>
                                    <a href="<?php echo e(route('make_bill', $row->id)); ?>"><span class="label label-warning"><i
                                ...
                                <select name="cust_id" class="form-control select2" style="width: 100%;">
                                    <?php $__currentLoopData = @$cust; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($row->id); ?>">
                                            <?php echo e($row->name); ?>----Rs:<?php echo e(@App\StockOut::where('cust_id', $row->id)->sum('amount') - @App\StockOut::where('cust_id', $row->id)->sum('payment')); ?>

                                            Tray<?php echo e(@App\StockOut::where('cust_id', $row->id)->sum('balance_t') - @App\StockOut::where('cust_id', $row->id)->sum('deposit_t')); ?>
                        ...
                        <?php $__currentLoopData = @$seller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td> <a href=""><span class="label label-danger">Delete</span></a>
                                    <a href="<?php echo e(route('stock_show', $row->id)); ?>"><span class="label label-primary"><i
